...
def curso(request, id):
    if request.session.get('usuario'):
        ...
        context = {'aulas': aulas, 'request_usuario': request_usuario}
...
def aula(request, id):
    if request.session.get('usuario'):
        ...
        context = {'aula': aula, 'usuario_id': usuario_id, 'comentarios': comentarios, 'request_usuario': request_usuario, 'usuario_avaliou': usuario_avaliou, 'avaliacoes': avaliacoes}
